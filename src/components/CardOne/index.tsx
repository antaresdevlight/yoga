...
function CardOne() {
    return (
        <Flex w="360px" h="470px" border="1px" direction="column" alignItems="center">
            <Image src={img1yoga} width={338} height={307} alt=""/>
            <Text fontSize="36px" fontWeight="400" lineHeight="normal" color="#B6990F">World Class Teacher</Text>
